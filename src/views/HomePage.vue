  ...
  <div id="HomePage">
    ...
    <div id="swiper" class="container-fuild">
      <div class="swiper-container banner-swiper">
        ...
        <!-- 如果需要分页器 -->
        <div class="swiper-pagination c-pagnation"></div>
...
export default {
  ...
  data() {
    return {
      swiperList: [
        {
          img: require("..//assets/portal/index/banner-a.png"),
          path: "",
          title: '您身边的IT专家1',
          content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("..//assets/portal/index/banner-b.png"),
          path: "",
          title: '您身边的IT专家2',
          content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("..//assets/portal/index/banner-c.png"),
          path: "",
          title: '您身边的IT专家3',
          content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("..//assets/portal/index/banner-d.jpg"),
          path: "",
          title: '您身边的IT专家4',
          content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        },
        {
          img: require("..//assets/portal/index/banner-e.png"),
          path: "",
          title: '您身边的IT专家4',
          content: '宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介宣传简介',
        }
